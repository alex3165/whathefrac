...
//#import <QCAR/TrackableResult.h> // Added by me (necessary ?)
...
- (void)renderFrameQCAR
{
    if (APPSTATUS_CAMERA_RUNNING == qUtils.appStatus) {
        ...
        NSLog(@"NumTrackable : %i", state.getNumTrackableResults());
        ...
        for(int i = 0; i < state.getNumTrackableResults(); ++i) {
            ...
            //assert(textureIndex < [textures count]); // <- Don't use
            
            NSLog(@"Marker ID is %i", markerID);
            
            if (markerID == 2) {
                NSString * appToLaunch = @"miroirs://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 3) {
                NSString * appToLaunch = @"lameMetal://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 4) {
                NSString * appToLaunch = @"retro://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 5) {
                NSString * appToLaunch = @"bouleRouge://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 6) {
                NSString * appToLaunch = @"rideauBoules://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 7) {
                NSString * appToLaunch = @"neons://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 8) {
                NSString * appToLaunch = @"pyramide://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 9) {
                NSString * appToLaunch = @"tourniquets://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 10) {
                NSString * appToLaunch = @"triedres://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 11) {
                NSString * appToLaunch = @"disques://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 12) {
                NSString * appToLaunch = @"ampoules://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 13) {
                NSString * appToLaunch = @"pixels://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 14) {
                NSString * appToLaunch = @"cylindreRotation://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 15) {
                NSString * appToLaunch = @"lumiereVibration://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
            if (markerID == 16) {
                NSString * appToLaunch = @"ARPixels://";
                [[UIApplication sharedApplication] openURL:[NSURL URLWithString:appToLaunch]];
            }
